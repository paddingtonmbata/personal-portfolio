export default function Nav() {
  return (
    <ul className="flex flex-row">
      ...
      <li className="p-3 flex justify-center">
        <a
          className="align-middle self-center py-1 px-3 w-full h-fit text-sky-500 border border-solid border-sky-500 transition relative bg-black raise " id="resume"
          href="#resume"
        >
          Resume
        </a>
